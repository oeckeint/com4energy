...
CREATE TABLE IF NOT EXISTS medida_qh (
    id_medida_qh BIGINT UNSIGNED NOT NULL COMMENT 'TSID app (no AUTO_INCREMENT, habilita JDBC batching). Rango BIGINT UNSIGNED: 0 .. 18,446,744,073,709,551,615',
    ...
    actent SMALLINT UNSIGNED NOT NULL COMMENT 'Magnitud energética. Rango SMALLINT UNSIGNED: 0 .. 65,535. Esperado: < 1k (zona segura ~10k)',
    qactent SMALLINT UNSIGNED NOT NULL COMMENT 'Código de calidad. Rango SMALLINT UNSIGNED: 0 .. 65,535. Esperado: < 1k',
    actsal SMALLINT UNSIGNED NOT NULL COMMENT 'Magnitud energética. Rango SMALLINT UNSIGNED: 0 .. 65,535. Esperado: < 1k (zona segura ~10k)',
    qactsal SMALLINT UNSIGNED NOT NULL COMMENT 'Código de calidad. Rango SMALLINT UNSIGNED: 0 .. 65,535. Esperado: < 1k',
    r_q1 SMALLINT UNSIGNED NOT NULL COMMENT 'Magnitud energética. Rango SMALLINT UNSIGNED: 0 .. 65,535. Esperado: < 1k (zona segura ~10k)',
    qr_q1 SMALLINT UNSIGNED NOT NULL COMMENT 'Código de calidad. Rango SMALLINT UNSIGNED: 0 .. 65,535. Esperado: < 1k',
    r_q2 SMALLINT UNSIGNED NOT NULL COMMENT 'Magnitud energética. Rango SMALLINT UNSIGNED: 0 .. 65,535. Esperado: < 1k (zona segura ~10k)',
    qr_q2 SMALLINT UNSIGNED NOT NULL COMMENT 'Código de calidad. Rango SMALLINT UNSIGNED: 0 .. 65,535. Esperado: < 1k',
    r_q3 SMALLINT UNSIGNED NOT NULL COMMENT 'Magnitud energética. Rango SMALLINT UNSIGNED: 0 .. 65,535. Esperado: < 1k (zona segura ~10k)',
    qr_q3 SMALLINT UNSIGNED NOT NULL COMMENT 'Código de calidad. Rango SMALLINT UNSIGNED: 0 .. 65,535. Esperado: < 1k',
    r_q4 SMALLINT UNSIGNED NOT NULL COMMENT 'Magnitud energética. Rango SMALLINT UNSIGNED: 0 .. 65,535. Esperado: < 1k (zona segura ~10k)',
    qr_q4 SMALLINT UNSIGNED NOT NULL COMMENT 'Código de calidad. Rango SMALLINT UNSIGNED: 0 .. 65,535. Esperado: < 1k',
    medres1 SMALLINT UNSIGNED NOT NULL COMMENT 'Magnitud energética. Rango SMALLINT UNSIGNED: 0 .. 65,535. Esperado: < 1k (zona segura ~10k)',
    qmedres1 SMALLINT UNSIGNED NOT NULL COMMENT 'Código de calidad. Rango SMALLINT UNSIGNED: 0 .. 65,535. Esperado: < 1k',
    medres2 SMALLINT UNSIGNED NOT NULL COMMENT 'Magnitud energética. Rango SMALLINT UNSIGNED: 0 .. 65,535. Esperado: < 1k (zona segura ~10k)',
